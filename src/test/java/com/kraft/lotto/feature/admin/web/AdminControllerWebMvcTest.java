...
class AdminControllerWebMvcTest {
    ...
    @Test
    @WithMockUser
    @DisplayName("GET /admin/ops/collection — 인증 사용자에게 200을 반환한다")
    ...
    @Test
    @WithMockUser
    @DisplayName("GET /admin/ops/audit — 인증 사용자에게 200을 반환한다")
    void auditPageIsOk() throws Exception {
        when(auditLogService.list(any())).thenReturn(Page.empty());
    ...
    @Test
    @WithMockUser
    @DisplayName("GET /admin/ops/news — 인증 사용자에게 200을 반환한다")
    ...
    @Test
    @DisplayName("POST /admin/ops/collection/latest — 수집 후 리다이렉트한다")
    ...
    @Test
    @DisplayName("POST /admin/ops/collection/stores — 수집 후 리다이렉트한다")
    ...
    @Test
    @DisplayName("POST /admin/ops/news/{id}/approve — 승인 후 리다이렉트한다")
    ...
    @Test
    @DisplayName("POST /admin/ops/news/{id}/reject — 거부 후 리다이렉트한다")
    ...
    @Test
    @DisplayName("POST /admin/ops/news/block-keyword — 차단 후 리다이렉트한다")
