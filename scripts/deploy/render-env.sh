...
umask 077
{
  ...
  printf 'KRAFT_API_KEY_ENABLED=%s\n' "${KRAFT_API_KEY_ENABLED:-false}"
  [[ -n "${KRAFT_API_KEY_KEYS:-}" ]] && printf 'KRAFT_API_KEY_KEYS=%s\n' "${KRAFT_API_KEY_KEYS}"
  printf 'KRAFT_FCM_ENABLED=%s\n' "${KRAFT_FCM_ENABLED:-false}"
  [[ -n "${KRAFT_FCM_CREDENTIALS_PATH:-}" ]] && printf 'KRAFT_FCM_CREDENTIALS_PATH=%s\n' "${KRAFT_FCM_CREDENTIALS_PATH}"
  [[ -n "${KRAFT_FCM_DRAW_RESULT_TOPIC:-}" ]] && printf 'KRAFT_FCM_DRAW_RESULT_TOPIC=%s\n' "${KRAFT_FCM_DRAW_RESULT_TOPIC}"
