  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {latest ? (
          <>
            <div style={{ fontSize: 22, color: "#c94f24", fontWeight: 700, marginBottom: 8 }}>최신 당첨 결과</div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 34 }}>
              ...
              <div style={{ width: BALL, height: BALL, borderRadius: "50%", background: ballColor(latest.bonusNumber).bg, display: "flex", alignItems: "center", justifyContent: "center", color: ballColor(latest.bonusNumber).fg, fontSize: 32, fontWeight: 800, boxShadow: "0 6px 20px rgba(0,0,0,0.15)", border: "3px dashed rgba(0,0,0,0.18)" }}>
                {latest.bonusNumber}
              </div>
            </div>
          ...
          <>
            <div style={{ fontSize: 40, fontWeight: 800, color: "#1d1a17", letterSpacing: -1, marginBottom: 14 }}>
              회차 결과 · 전체 목록
            </div>
            <div style={{ fontSize: 24, color: "#5e564c" }}>
              로또 6/45 모든 회차를 한눈에
            </div>
          </>
        )}
