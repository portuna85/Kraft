  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ fontSize: 48, fontWeight: 800, color: "#1d1a17", letterSpacing: -1, marginBottom: 10 }}>번호 출현 통계</div>
        <div style={{ fontSize: 22, color: "#5e564c", marginBottom: 40 }}>1회부터 최신 회차까지 전 번호 출현 빈도 분석</div>
        ...
        <div style={{ display: "flex", alignItems: "flex-end", gap: 18 }}>
          {SAMPLE.map(({ n, pct }) => (
            <div key={n} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
              ...
              />
              <div style={{ width: 52, height: 52, borderRadius: "50%", background: "#f5c842", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20, fontWeight: 800, color: "#1d1a17" }}>
                {n}
              </div>
            </div>
          ))}
