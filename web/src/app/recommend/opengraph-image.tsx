  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ fontSize: 48, fontWeight: 800, color: "#1d1a17", letterSpacing: -1, marginBottom: 10 }}>번호 추천</div>
        <div style={{ fontSize: 22, color: "#5e564c", marginBottom: 40 }}>보안 난수로 생성하는 나만의 로또 조합</div>
